...
- The narrative voice is peer-to-peer: precise, direct, argument-forward. Technical terms are used correctly and defined once on first reference. The reader is assumed capable; the prose does not scaffold or hand-hold. Full voice specification: `voice/style-card.md` and `voice/generative-patterns.md`.
